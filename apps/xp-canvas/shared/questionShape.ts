...
declare module '@tldraw/tlschema' {
	export interface TLGlobalShapePropsMap {
		question: { w: number; h: number; question: string; answers: string[]; correct: number; answered: number[]; revision: string }
	}
}
export type QuestionShape = TLShape<'question'>
export type QuestionFeedback = { type: 'question-result'; id: string; shapeId: string; revision: string; answer: number; correct: boolean }
